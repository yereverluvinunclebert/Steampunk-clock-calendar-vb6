   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":5665
            Left            =   1530
            List            =   "frmPrefs.frx":5667
            Style           =   2  'Dropdown List
            TabIndex        =   52
...
Public Sub positionPrefsMonitor()
    ...
    If Me.Left > virtualScreenWidthTwips - 2500 Then
        Me.Left = virtualScreenWidthTwips - 2500
    End If
    If Me.Top > virtualScreenHeightTwips - 2500 Then
        Me.Top = virtualScreenHeightTwips - 2500
    End If
    ...
    If Val(gblFormHeightTwips) <= 0 Then
        Me.Height = prefsCurrentHeight
    Else
        Me.Height = Val(gblFormHeightTwips)
    End If
...
Private Sub positionPrefsFramesButtons()
    ...
    Me.Width = rightHandAlignment + leftHandGutterWidth + 75 ' (not quite sure why we need the 75 twips padding) ' this triggers a resize '
...
Private Sub populatePrefsComboBoxes()
    ...
    If monitorCount >= 1 Then
        ' populate the hiding timer combobox
        cmbMultiMonitorResize.AddItem "Resize by screen size proportion", 0
        cmbMultiMonitorResize.ItemData(0) = 1
        cmbMultiMonitorResize.AddItem "Resize to 85%", 1
        cmbMultiMonitorResize.ItemData(1) = 85
        cmbMultiMonitorResize.AddItem "Resize to 75%", 2
        cmbMultiMonitorResize.ItemData(2) = 75
        cmbMultiMonitorResize.AddItem "Resize to 60%", 3
        cmbMultiMonitorResize.ItemData(3) = 60
        cmbMultiMonitorResize.AddItem "Resize to 50%", 4
        cmbMultiMonitorResize.ItemData(4) = 50
...
Private Sub Form_Resize()
    ...
    If prefsDynamicSizingFlg = True Then
        ...
        Me.Width = Me.Height / ratio ' maintain the aspect ratio, note: this change calls this routine again...
